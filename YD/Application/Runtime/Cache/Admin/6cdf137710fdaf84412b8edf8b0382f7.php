<?php if (!defined('THINK_PATH')) exit();?>﻿<div class="pageContent">
    <form method="post" action="/YDesigner/index.php/Design/addRootNode/app_id/19.html?_=1452067281018" class="pageForm required-validate" onsubmit="return validateCallback(this, nodeAjaxDone);">
